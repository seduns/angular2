...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p kIQUpdMMx1YivKL3
```

> `kIQUpdMMx1YivKL3` is the password of the certificate, you can change it to any password you want.
